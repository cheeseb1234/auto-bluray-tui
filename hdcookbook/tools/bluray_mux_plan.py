...
''')
    ...
    lines.append('')
    lines.append('The final ISO assembly uses tsMuxer output for each title and patches playlist/clip IDs to match the PowerPoint button map. Validate the ISO in software before burning physical media.')
