...
class StartLauncherTests(unittest.TestCase):
    ...
    def test_main_calls_tui_in_process_after_preflight(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with (
                mock.patch.object(start, "preflight") as preflight,
    ...
    def test_find_java_executable_surfaces_dependency_probe_error(self):
        ...
        fake_deps.find_java_executable.side_effect = RuntimeError(
            "Java is not installed. Install temurin@17."
        )

        with (
            mock.patch.object(start, "_dependency_checks", return_value=fake_deps),
    ...
    def test_doctor_includes_centralized_version(self):
        ...
        with (
            mock.patch.object(start, "check_tool", side_effect=fake_check_tool),
    ...
    def test_doctor_includes_expanded_dependency_probe_lines(self):
        ...
        with (
            ...
            mock.patch.object(
                start,
                "check_udf_iso_creator",
                return_value=(["/usr/bin/xorriso", "-as", "mkisofs"], "supports -udf"),
            ),
